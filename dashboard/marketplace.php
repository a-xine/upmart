...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li id="nav-dynamic">
                <a id="dynamic-link"><span class="icon">𖠩</span>My Orders</a>
            </li>
    ...
    <div class="main-content">
        <div class="dash-header">
            <h1 style="font-size: 1.4rem; margin-top: 10px; margin-left: 30px;"><span>🛒</span> Marketplace</h1>

            <div class="status-indicators" style="margin-right: 30px;">
        ...
        <div class="header-actions" id="searchbar" style="margin-left: 30px;">
        ...
        <div class="category-wrapper" id="category-nav" style="margin-left: 30px;">
            ...
            <button class="filter-pill" data-category="9">Arki Materials</button>
                ...
                <section class="bento-card form-section">
                    ...
                    <form id="product-form" action="handle_actions.php" method="POST" enctype="multipart/form-data">
                        ...
                        <select name="category_id" id="category-select" class="input-modern" required>
                            ...
                            <option value="9">Arki Materials</option>
                        ...
                        <select name="condition" class="input-modern" required>
                            ...
                            <option value="Like New">Used but Good as New</option>
