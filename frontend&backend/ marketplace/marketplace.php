<?php 
session_start(); // 1. Added session start

// 2. Fixed path to database (assumes marketplace is in a subfolder)
include '../db_connect.php'; 

// 3. Security: Kick out users who aren't logged in
...
<body>
    <div class="main-panel-container"> <nav class="sidebar">
            ...
            <ul class="nav-links">
                <li id="nav-dashboard">
                    <a href="../includes/mainweb.php"><span class="icon">🏠︎</span> Dashboard</a>
                </li>
