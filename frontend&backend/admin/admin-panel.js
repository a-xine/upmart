    ...
    window.showPreview = function (title, seller, price, description, imgUrl, category, sImg) {
        ...
        console.lg("Category received:", category);
        console.log("Seller Image received:", sImg);
        console.log("Product Images (imgUrl) received:", imgUrl);o

        try {
            const emptyState = document.getElementById('emptyState');
            const content = document.getElementById('previewContent');
            const userImgElement = document.getElementById('prevUserImg');
            const catElement = document.getElementById('prevCategory');

            // Target the container for product images
            const imgContainer = document.getElementById('prevImgContainer');

            if (!emptyState || !content || !imgContainer) return;
            ...
            if (imgUrl && imgUrl.trim() !== "" && imgUrl !== 'default_product.png') {
                ...
                images.forEach(path => {
                    ...
                    // Ensure pathing is correct (steps back to root uploads)
                    imgTag.src = trimPath.includes('../') ? trimPath : '../dashboard/' + trimPath;

                    // Apply marketplace-style formatting
                    imgTag.classList.add('side-main-img');
                ...
                fallback.src = '../images/default_product.png';
            ...
            console.error("showPreview Error:", err.message);
        }
    };
    ...
    function filterReports() {
        ...
        // Redirects to admin_report.php?category=Spam
        window.location.href = 'admin_report.php?category=' + encodeURIComponent(filterValue);
    }
